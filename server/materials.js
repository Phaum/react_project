...
const markdownFolder = "./markdown-files-materials";
const uploadFolder = "./uploads-materials";
materialsRouter.use("/uploads-materials", express.static(path.join(__dirname, "uploads-materials")));
